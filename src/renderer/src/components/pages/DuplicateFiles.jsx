  ...
  return (
    <Page title="Duplicate Files Finder">
      ...
      <textarea
        ...
        placeholder="Add at least two files or a folder with two files and press 'submit.' Adding a folder also adds the files of its subfolders (its whole folder tree). The more files a folder has, the more time it can take to add the files, which can be noticeable. Also, the more files we add, the longer it takes to find duplicate files."
      />
    </Page>
  )
}
